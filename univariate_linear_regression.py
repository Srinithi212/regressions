...
Original file is located at
    https://colab.research.google.com/drive/1EotlZVE9OtdZohY0XpIxg-x4xUk1nfyp
"""
...
path='/gdrive/My Drive/machineLearning/'

raw_data=pd.read_csv(path+'Chennai_house_univariate.csv')
raw_data.head()

raw_data.plot(kind='scatter',x='Size',y='Price')
...
x=data.iloc[:, 0:2] #iloc[rows, columns]
x.head()
